...
import { isStyleDescriptorArray, Specificity, specificityCompareFn } from "../utilities/index.js";
import { modifyRuleForPlaceholder, modifyRuleForSelection } from "./pseudo-elements.js";
import { getClassNameSelectors, toRNProperty } from "./selector-builder.js";
...
export class StylesheetBuilder {
  ...
  getRuleSets() {
    ...
    return Object.entries(this.shared.ruleSets).map(([key, value]) => [key, value.sort((a, b) => specificityCompareFn(a, b))]);
  }
  ...
  applyRuleToSelectors(selectorList = this.selectors) {
    ...
    const normalizedSelectors = getClassNameSelectors(selectorList, this.options);
